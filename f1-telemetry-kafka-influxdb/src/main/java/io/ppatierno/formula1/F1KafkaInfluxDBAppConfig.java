...
public class F1KafkaInfluxDBAppConfig {
    ...
    private F1KafkaInfluxDBAppConfig(String kafkaBootstrapServers, String influxDbUrl, String f1DriversTopic, String f1EventsTopic) {
    ...
    public static F1KafkaInfluxDBAppConfig fromEnv() {
        ...
        return new F1KafkaInfluxDBAppConfig(kafkaBootstrapServers, influxDbUrl, f1DriversTopic, f1EventsTopic);
    }
